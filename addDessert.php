<?php include_once 'addToDessert.php'; ?>
<?php include_once 'parseJSON.php'; ?>
<!DOCTYPE html>
 <html>
  <head>
	<title>Agregar Postres</title>
  <meta charset="utf-8">
    ...
    <body>
      <nav class="navbar navbar-inverse">
        <div class="container-fluid">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="addDessert.php">Postres</a></li>
      ...
      <div class="container">
    	  ...
    	  <div class="col-md-8">
    		<h3>Menú actual</h3>
    			<?php
    				foreach($objPostres as $obj){
	              echo '<strong>Platillo: </strong>' . $obj->name . '<br /><strong> Descripción: </strong>' . $obj->desc. '<br/><strong> Precio: </strong>' . $obj->prize . ' <hr />';    				}
    			?>
    		</div>
    		</div>
        </div>
