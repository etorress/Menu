<?php include_once 'addToDinner.php'; ?>
<?php include_once 'parseJSON.php'; ?>
<!DOCTYPE html>
 <html>
  <head>
  <meta charset="utf-8">
	<title>Agregar Cena</title>
      ...
      <nav class="navbar navbar-inverse">
        <div class="container-fluid">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="addDinner.php">Cenas</a></li>
